...
// Package kchainvm implements the K-Chain Virtual Machine for distributed
...
func (vm *VM) Initialize(
	...
	vm.log.Info("K-Chain VM initialized",
		"version", Version,
...
func (vm *VM) SetState(ctx context.Context, state consensusinterfaces.State) error {
	vm.log.Info("K-Chain VM state transition", "state", fmt.Sprintf("%v", state))
	return nil
}
...
func (vm *VM) Shutdown(ctx context.Context) error {
	...
	vm.log.Info("shutting down K-Chain VM")
	...
	vm.log.Info("K-Chain VM shutdown complete")
	return nil
}

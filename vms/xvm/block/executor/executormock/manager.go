...
<<<<<<< HEAD:vms/avm/block/executor/executormock/manager.go
// Source: github.com/luxfi/node/vms/avm/block/executor (interfaces: Manager)
=======
// Source: github.com/luxfi/node/vms/xvm/block/executor (interfaces: Manager)
>>>>>>> origin/regenesis-runtime-replay:vms/xvm/block/executor/executormock/manager.go
//

...
// Source: github.com/luxfi/node/vms/xvm/metrics (interfaces: Metrics)
//
// Generated by this command:
//
//	mockgen -package=metrics -destination=vms/xvm/metrics/mock_metric.go github.com/luxfi/node/vms/xvm/metrics Metrics
//

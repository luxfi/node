...
// Source: github.com/luxfi/node/vms/xvm/state (interfaces: State)
//
// Generated by this command:
//
//	mockgen -package=statemock -destination=vms/xvm/state/statemock/state.go -mock_names=State=State github.com/luxfi/node/vms/xvm/state State
//
...
func (m *State) AddUTXO(arg0 *utxo.UTXO) {
	m.ctrl.T.Helper()
...
func (m *State) GetUTXO(utxoID ids.ID) (*utxo.UTXO, error) {
	m.ctrl.T.Helper()
...
func (m *State) UTXOs(start ids.ID, limit int) ([]*utxo.UTXO, error) {
	m.ctrl.T.Helper()
...
func (mr *StateMockRecorder) UTXOs(start, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UTXOs", reflect.TypeOf((*State)(nil).UTXOs), start, limit)
}

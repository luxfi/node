...
// Source: github.com/luxfi/node/vms/xvm/state (interfaces: Chain)
//
// Generated by this command:
//
//	mockgen -package=statemock -destination=vms/xvm/state/statemock/chain.go -mock_names=Chain=Chain github.com/luxfi/node/vms/xvm/state Chain
//
...
func (m *Chain) AddUTXO(arg0 *utxo.UTXO) {
	m.ctrl.T.Helper()
...
func (m *Chain) GetUTXO(utxoID ids.ID) (*utxo.UTXO, error) {
	m.ctrl.T.Helper()
...
func (m *Chain) UTXOs(start ids.ID, limit int) ([]*utxo.UTXO, error) {
	m.ctrl.T.Helper()
...
func (mr *ChainMockRecorder) UTXOs(start, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UTXOs", reflect.TypeOf((*Chain)(nil).UTXOs), start, limit)
}

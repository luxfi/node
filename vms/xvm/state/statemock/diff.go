...
// Source: github.com/luxfi/node/vms/xvm/state (interfaces: Diff)
//
// Generated by this command:
//
//	mockgen -package=statemock -destination=vms/xvm/state/statemock/diff.go -mock_names=Diff=Diff github.com/luxfi/node/vms/xvm/state Diff
//
...
func (m *Diff) AddUTXO(arg0 *utxo.UTXO) {
	m.ctrl.T.Helper()
...
func (m *Diff) GetUTXO(utxoID ids.ID) (*utxo.UTXO, error) {
	m.ctrl.T.Helper()
...
func (m *Diff) UTXOs(start ids.ID, limit int) ([]*utxo.UTXO, error) {
	m.ctrl.T.Helper()
...
func (mr *DiffMockRecorder) UTXOs(start, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UTXOs", reflect.TypeOf((*Diff)(nil).UTXOs), start, limit)
}

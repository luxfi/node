...
//
//	mockgen -package=mempoolmock -destination=vms/avm/txs/mempool/mempoolmock/mempool.go -mock_names=Mempool=Mempool github.com/luxfi/node/vms/xvm/txs/mempool Mempool
//

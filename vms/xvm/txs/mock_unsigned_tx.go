...
//
//	mockgen -source=vms/xvm/txs/tx.go -destination=vms/xvm/txs/mock_unsigned_tx.go -package=txs
//
...
func (m *MockUnsignedTx) InitializeWithContext(ctx context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockUnsignedTxMockRecorder) InitializeWithContext(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InitializeWithContext", reflect.TypeOf((*MockUnsignedTx)(nil).InitializeWithContext), ctx)
}

...
description: This page is an overview of the UTXO Chain (X-Chain) API associated with Lux Node.
sidebar_label: API
...
Endpoint deprecated as of [**v1.9.12**](https://github.com/luxfi/node/releases/tag/v1.9.12).

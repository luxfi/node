...
func TestServiceGetTxJSON_BaseTx(t *testing.T) {
	...
	"id": %q
}`, newTx.Unsigned.(*txs.BaseTx).BlockchainID, assetID, assetID, assetID, assetID, sigStr, newTx.ID())
...
func TestServiceGetTxJSON_ExportTx(t *testing.T) {
	...
	"id": %q
}`, newTx.Unsigned.(*txs.ExportTx).BlockchainID, assetID, assetID, assetID, assetID, sigStr, newTx.ID())
...
func TestServiceGetTxJSON_CreateAssetTx(t *testing.T) {
	...
	"id": %q
}`, createAssetTx.Unsigned.(*txs.CreateAssetTx).BlockchainID, assetID, assetID, assetID, sigStr, createAssetTx.ID().String())
...
func TestServiceGetTxJSON_OperationTxWithNftxMintOp(t *testing.T) {
	...
	assetID := env.genesisTx.ID()
	args := []any{mintNFTTx.Unsigned.(*txs.OperationTx).BlockchainID, assetID, assetID, sigStr, mintNFTTx.ID(), createAssetTx.ID()}
	expectedReplyTxString := fmt.Sprintf(`{
	"unsignedTx": {
		"networkID": 10,
		"blockchainID": %[1]q,

...
//
//	mockgen -package=utxomock -destination=vms/platformvm/utxo/utxomock/verifier.go -mock_names=Verifier=Verifier github.com/luxfi/node/vms/platformvm/utxo Verifier
//

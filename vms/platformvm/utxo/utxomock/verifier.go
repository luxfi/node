...
func (m *Verifier) VerifySpend(tx txs.UnsignedTx, utxoDB utxo.UTXOGetter, ins []*utxo.TransferableInput, outs []*utxo.TransferableOutput, creds []verify.Verifiable, unlockedProduced map[ids.ID]uint64) error {
	m.ctrl.T.Helper()
...
func (m *Verifier) VerifySpendUTXOs(tx txs.UnsignedTx, utxos []*utxo.UTXO, ins []*utxo.TransferableInput, outs []*utxo.TransferableOutput, creds []verify.Verifiable, unlockedProduced map[ids.ID]uint64) error {
	m.ctrl.T.Helper()

...
// SubnetToL1ConversionID creates a net conversion ID from the provided
// net conversion data.
...
// SubnetToL1Conversion reports the summary of the net conversation that
// occurred on the P-chain.
type SubnetToL1Conversion struct {
	payload

	// ID of the net conversion. It is typically generated by calling

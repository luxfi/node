...
func TestParse(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			bytes: []byte{
				// Codec version (uint16 LE):
				0x00, 0x00,
				// Payload type = ChainToL1Conversion (uint32 LE = 0):
				0x00, 0x00, 0x00, 0x00,
				// ID (32-byte array, byte-identical):
		...
		},
		{
			...
			bytes: []byte{
				...
				0x01, 0x00, 0x00, 0x00,
				// ChainID (32-byte array, byte-identical):
				0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
				0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10,
				0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18,
				0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x20,
				// NodeID Length (uint32 LE = 20):
				0x14, 0x00, 0x00, 0x00,
				// NodeID:
		...
		},
		{
			...
			bytes: []byte{
				...
				0x02, 0x00, 0x00, 0x00,
				// ValidationID (32-byte array, byte-identical):
				0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
				0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10,
				0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18,
				0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x20,
				// Registered (bool, single byte):
				0x00,
			},

...
// Source: github.com/luxfi/node/vms/platformvm/block (interfaces: Block)
//
// Generated by this command:
//
//	mockgen -package=block -destination=vms/platformvm/block/mock_block.go github.com/luxfi/node/vms/platformvm/block Block
//

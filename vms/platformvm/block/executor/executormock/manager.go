...
// Source: github.com/luxfi/node/vms/platformvm/block/executor (interfaces: Manager)
//
...
import (
	...
	state "github.com/luxfi/node/v2/vms/platformvm/state"
...
func (m *Manager) NewBlock(arg0 block.Block) linear.Block {
	m.ctrl.T.Helper()

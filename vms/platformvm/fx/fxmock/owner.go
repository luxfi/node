...
// Source: github.com/luxfi/node/vms/platformvm/fx (interfaces: Owner)
//
// Generated by this command:
//
//	mockgen -package=fxmock -destination=vms/platformvm/fx/fxmock/owner.go -mock_names=Owner=Owner github.com/luxfi/node/vms/platformvm/fx Owner
//
...
func (m *Owner) InitCtx(arg0 *quasar.Context) {
	m.ctrl.T.Helper()

...
// Source: github.com/luxfi/node/vms/platformvm/fx (interfaces: Fx)
//
// Generated by this command:
//
//	mockgen -package=fxmock -destination=vms/platformvm/fx/fxmock/fx.go -mock_names=Fx=Fx github.com/luxfi/node/vms/platformvm/fx Fx
//

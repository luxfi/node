...
// Source: github.com/luxfi/node/vms/platformvm/state (interfaces: Chain,Diff,State,Versions)
//
// Generated by this command:
//
//	mockgen -package=state -destination=vms/platformvm/state/mock_state.go github.com/luxfi/node/vms/platformvm/state Chain,Diff,State,Versions
//
...
func (m *MockState) ReindexBlocks(arg0 sync.Locker, arg1 log.Logger) error {
	m.ctrl.T.Helper()

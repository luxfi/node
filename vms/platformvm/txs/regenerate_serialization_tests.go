...
func updateTestFile(testName, actualBytes string) {
	...
	fileMap := map[string]string{
		...
		"TestConvertNetToL1TxSerialization":                  "convert_net_to_l1_tx_test.go",
		...
		"TestRemoveNetValidatorTxSerialization":              "remove_net_validator_tx_test.go",
		"TestSetL1ValidatorWeightTxSerialization":            "set_l1_validator_weight_tx_test.go",
		"TestTransferNetOwnershipTxSerialization":            "transfer_net_ownership_tx_test.go",
		"TestTransformNetTxSerialization":                    "transform_net_tx_test.go",
	}

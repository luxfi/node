...
// Source: github.com/luxfi/node/vms/platformvm/txs/builder (interfaces: Builder)
...
func (m *MockBuilder) NewCreateNetTx(arg0 uint32, arg1 []ids.ShortID, arg2 []*secp256k1.PrivateKey, arg3 ids.ShortID) (*txs.Tx, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewCreateNetTx", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*txs.Tx)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockBuilderMockRecorder) NewCreateNetTx(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewCreateNetTx", reflect.TypeOf((*MockBuilder)(nil).NewCreateNetTx), arg0, arg1, arg2, arg3)
}

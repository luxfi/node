...
var (
	_ UnsignedTx = (*CreateBlockchainTx)(nil)
...
// CreateBlockchainTx is an unsigned createBlockchainTx
...
func (tx *CreateBlockchainTx) SyntacticVerify(ctx *consensusctx.Context) error {
	switch {
	case tx == nil:
		return ErrNilTx
...
func (tx *CreateBlockchainTx) Visit(visitor Visitor) error {
	return visitor.CreateBlockchainTx(tx)
}

// InitializeWithContext initializes the transaction with consensus context
func (tx *CreateBlockchainTx) InitializeWithContext(ctx context.Context) error {

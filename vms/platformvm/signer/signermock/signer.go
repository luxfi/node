...
// Source: github.com/luxfi/node/vms/platformvm/signer (interfaces: Signer)
//
// Generated by this command:
//
//	mockgen -package=signermock -destination=signermock/signer.go -mock_names=Signer=Signer . Signer
//

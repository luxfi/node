...
// Source: github.com/luxfi/node/vms/proposervm (interfaces: PostForkBlock)
//
...
func (mr *MockPostForkBlockMockRecorder) ParentID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParentID", reflect.TypeOf((*MockPostForkBlock)(nil).ParentID))
}
...
func (m *MockPostForkBlock) pChainEpoch(arg0 context.Context) (chain.Epoch, error) {
	m.ctrl.T.Helper()

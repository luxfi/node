...
import (
	...
	blockbuilder "github.com/luxfi/node/v2/vms/proposervm/block"
)
...
func TestBatchedParseBlockPreForkOnly(t *testing.T) {
	...
	coreVM.BatchedParseBlockF = func(_ context.Context, blks [][]byte) ([]linear.Block, error) {
		res := make([]linear.Block, 0, len(blks))

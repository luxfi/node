...
func BuildUnsigned(
	...
	unsignedBytes := buildUnsignedBuffer(parentID, encodeTimestamp(timestamp), pChainHeight, epoch, nil, blockBytes)
...
func buildSigned(
	...
	unsignedBytes := buildUnsignedBuffer(parentID, encodeTimestamp(timestamp), pChainHeight, epoch, idSlot, blockBytes)

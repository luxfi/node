...
// Source: github.com/luxfi/node/vms/proposervm/state (interfaces: State)
//
// Generated by this command:
//
//	mockgen -package=state -destination=vms/proposervm/state/mock_state.go github.com/luxfi/node/vms/proposervm/state State
//

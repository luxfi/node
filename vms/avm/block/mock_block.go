...
// Source: github.com/luxfi/node/vms/avm/block (interfaces: Block)
//
// Generated by this command:
//
//	mockgen -package=block -destination=vms/avm/block/mock_block.go github.com/luxfi/node/vms/avm/block Block
//

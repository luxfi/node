...
// Source: github.com/luxfi/node/vms/avm/state (interfaces: State)
//
// Generated by this command:
//
//	mockgen -package=statemock -destination=vms/avm/state/statemock/state.go -mock_names=State=State github.com/luxfi/node/vms/avm/state State
//
...
func (m *State) AddUTXO(arg0 *lux.UTXO) {
	m.ctrl.T.Helper()
...
func (m *State) GetUTXO(arg0 ids.ID) (*lux.UTXO, error) {
	m.ctrl.T.Helper()

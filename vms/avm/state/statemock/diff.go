...
// Source: github.com/luxfi/node/vms/avm/state (interfaces: Diff)
//
// Generated by this command:
//
//	mockgen -package=statemock -destination=vms/avm/state/statemock/diff.go -mock_names=Diff=Diff github.com/luxfi/node/vms/avm/state Diff
//
...
func (m *Diff) AddUTXO(arg0 *lux.UTXO) {
	m.ctrl.T.Helper()
...
func (m *Diff) GetUTXO(arg0 ids.ID) (*lux.UTXO, error) {
	m.ctrl.T.Helper()

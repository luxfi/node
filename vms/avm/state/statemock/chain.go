...
// Source: github.com/luxfi/node/vms/avm/state (interfaces: Chain)
//
// Generated by this command:
//
//	mockgen -package=statemock -destination=vms/avm/state/statemock/chain.go -mock_names=Chain=Chain github.com/luxfi/node/vms/avm/state Chain
//
...
func (m *Chain) AddUTXO(arg0 *lux.UTXO) {
	m.ctrl.T.Helper()
...
func (m *Chain) GetUTXO(arg0 ids.ID) (*lux.UTXO, error) {
	m.ctrl.T.Helper()

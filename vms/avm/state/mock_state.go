...
// Source: github.com/luxfi/node/vms/avm/state (interfaces: Chain,State,Diff)
//
// Generated by this command:
//
//	mockgen -package=state -destination=vms/avm/state/mock_state.go github.com/luxfi/node/vms/avm/state Chain,State,Diff
//

...
// Source: github.com/luxfi/node/vms/exchangevm/metrics (interfaces: Metrics)
//
// Generated by this command:
//
//	mockgen -package=metrics -destination=vms/xvm/metrics/mock_metrics.go github.com/luxfi/node/vms/exchangevm/metrics Metrics
//

...
//
//	mockgen -package=registrymock -destination=vms/registry/registrymock/vm_registry.go -mock_names=VMRegistry=VMRegistry github.com/luxfi/node/vms/registry VMRegistry
//

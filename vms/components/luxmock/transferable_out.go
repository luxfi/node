...
//
//	mockgen -package=avaxmock -destination=vms/components/lux/avaxmock/transferable_out.go -mock_names=TransferableOut=TransferableOut github.com/luxfi/node/vms/components/lux TransferableOut
//

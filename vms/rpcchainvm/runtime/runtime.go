...
var (
	ErrProtocolVersionMismatch = errors.New("RPCChainVM protocol version mismatch between Lux and Virtual Machine plugin")
...
type Initializer interface {
	// Initialize provides Lux with compatibility, networking and

...
- **Aggregated Signatures**: Support for BLS (free), Corona (premium), and CGGMP21
- **Zero-Knowledge Proofs**: Groth16, PLONK, and Bulletproofs support
- **Ring Signatures**: Corona implementation for validator privacy
...
- **Corona Signatures**: Anonymous validator participation
...
- [Corona Implementation Guide](CORONA_IMPLEMENTATION_GUIDE.md)
...
- Aggregated signature framework (BLS/Corona)

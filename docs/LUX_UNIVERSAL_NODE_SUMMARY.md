...
### 2. 🔐 Quantum-Safe Security (Corona)
- **Post-quantum signatures on ALL chains**: P, X, C, B, and Z
- **Corona lattice-based cryptography**: 256-bit quantum security
...
Lux Network:
  ...
  Consensus: Avalanche Snowman + Corona
  
B-Chain:
  Validators: 100 (NFT-controlled)
  MPC Threshold: 67/100
  Protocols: CGGMP21 + Corona
...
2. **Quantum-safe**: Future-proof security with Corona
...
4. [Corona Implementation](./CORONA_IMPLEMENTATION_GUIDE.md)
...
3. **Integrate Corona library**
   ```bash
   go get github.com/luxfi/corona-go
   ```

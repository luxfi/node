...
// Source: github.com/luxfi/node/chain/engine/snowman/block (interfaces: FullVM)
//
...
import (
	...
	block "github.com/luxfi/node/chain/engine/snowman/block"
...
func (m *FullVM) Initialize(ctx context.Context, chainCtx *snow.Context, db database.Database, genesisBytes, upgradeBytes, configBytes []byte, fxs []*core.Fx, appSender core.AppSender) error {
	m.ctrl.T.Helper()

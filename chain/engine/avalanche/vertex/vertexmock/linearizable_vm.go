...
// Source: github.com/luxfi/node/chain/engine/avalanche/vertex (interfaces: LinearizableVM)
//
...
import (
	...
	snowman "github.com/luxfi/node/chain/consensus/snowman"
	snowstorm "github.com/luxfi/node/chain/consensus/snowstorm"
	common "github.com/luxfi/node/chain/engine/common"
...
func (m *LinearizableVM) Initialize(ctx context.Context, chainCtx *snow.Context, db database.Database, genesisBytes, upgradeBytes, configBytes []byte, fxs []*core.Fx, appSender core.AppSender) error {
	m.ctrl.T.Helper()

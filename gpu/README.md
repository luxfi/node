...
```
gpu/gpu.go, plugin_cgo.go, plugin_nocgo.go   Go     package github.com/luxfi/node/gpu
...
The C++ target also compiles the reused `lux-private/crypto` bodies its CPU half

...
// D-Chain uses. Ported field-for-field from the Go definition (luxfi/zap
// builder.go + zap.go), because the wire is a contract: bytes written here must
// read back the same everywhere, or two implementations are two chains.
//

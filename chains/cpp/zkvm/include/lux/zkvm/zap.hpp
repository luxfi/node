...
// Z-Chain uses. Ported field-for-field from the Go definition (luxfi/zap
// builder.go + zap.go), because the wire is a contract: a Z-Chain tx built here

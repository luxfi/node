...
type GetValidatorSetRequest struct {
	...
	Height uint64 `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	NetId  []byte `protobuf:"bytes,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
}
...
func (x *GetValidatorSetRequest) GetNetId() []byte {
	if x != nil {
		return x.NetId
	}
	return nil
...
func (x *GetCurrentValidatorSetRequest) GetNetId() []byte {
	if x != nil {
		return x.NetId
	}
	return nil

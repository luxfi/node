...
type QuasarFinalityCertificate struct {
	...
	Epoch           uint32                 `protobuf:"varint,3,opt,name=epoch,proto3" json:"epoch,omitempty"`                                             // Corona key epoch or version used for this cert
	...
	CoronaSig     []byte                 `protobuf:"bytes,5,opt,name=corona_sig,json=coronaSig,proto3" json:"corona_sig,omitempty"`               // Final Corona threshold signature for the block
...
func (x *QuasarFinalityCertificate) GetCoronaSig() []byte {
	if x != nil {
		return x.CoronaSig
	}
	return nil
...
type QuasarPartialSig struct {
	...
	CoronaCommitment []byte                 `protobuf:"bytes,4,opt,name=corona_commitment,json=coronaCommitment,proto3" json:"corona_commitment,omitempty"` // Round 1 data for Corona (if applicable)
	CoronaSigShare   []byte                 `protobuf:"bytes,5,opt,name=corona_sig_share,json=coronaSigShare,proto3" json:"corona_sig_share,omitempty"`     // Round 2 data: the validator's Corona signature share
...
func (x *QuasarPartialSig) GetCoronaCommitment() []byte {
	if x != nil {
		return x.CoronaCommitment
	}
	return nil
}

func (x *QuasarPartialSig) GetCoronaSigShare() []byte {
	if x != nil {
		return x.CoronaSigShare
	}
	return nil
}
...
type QuasarKeyRotation struct {
	...
	NewCoronaPublicKey []byte                 `protobuf:"bytes,3,opt,name=new_corona_public_key,json=newCoronaPublicKey,proto3" json:"new_corona_public_key,omitempty"`
...
func (x *QuasarKeyRotation) GetNewCoronaPublicKey() []byte {
	if x != nil {
		return x.NewCoronaPublicKey
	}
	return nil
}
...
type QuasarMisbehaviorEvidence struct {
	...
	MissingCoronaShare []byte                 `protobuf:"bytes,4,opt,name=missing_corona_share,json=missingCoronaShare,proto3" json:"missing_corona_share,omitempty"` // Empty if not provided
	InvalidCoronaShare []byte                 `protobuf:"bytes,5,opt,name=invalid_corona_share,json=invalidCoronaShare,proto3" json:"invalid_corona_share,omitempty"` // If provided but found invalid
...
func (x *QuasarMisbehaviorEvidence) GetMissingCoronaShare() []byte {
	if x != nil {
		return x.MissingCoronaShare
	}
	return nil
}

func (x *QuasarMisbehaviorEvidence) GetInvalidCoronaShare() []byte {
	if x != nil {
		return x.InvalidCoronaShare
	}
	return nil
}
...
type QuasarDoubleSignEvidence struct {
	...
	CoronaSigShare_1 []byte                 `protobuf:"bytes,6,opt,name=corona_sig_share_1,json=coronaSigShare1,proto3" json:"corona_sig_share_1,omitempty"`
	CoronaSigShare_2 []byte                 `protobuf:"bytes,7,opt,name=corona_sig_share_2,json=coronaSigShare2,proto3" json:"corona_sig_share_2,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *QuasarDoubleSignEvidence) GetCoronaSigShare_1() []byte {
	if x != nil {
		return x.CoronaSigShare_1
	}
	return nil
}

func (x *QuasarDoubleSignEvidence) GetCoronaSigShare_2() []byte {
	if x != nil {
		return x.CoronaSigShare_2
	}
	return nil
}
...
const file_quasar_quasar_proto_rawDesc = "" +
	...
	"\fcorona_sig\x18\x05 \x01(\fR\vcoronaSig\x12\x1d\n" +
	"\n" +
	...
	"\x13corona_commitment\x18\x04 \x01(\fR\x12coronaCommitment\x12,\n" +
	"\x12corona_sig_share\x18\x05 \x01(\fR\x10coronaSigShare\x12\x1c\n" +
	...
	"\x17new_corona_public_key\x18\x03 \x01(\fR\x14newCoronaPublicKey\x12'\n" +
	...
	"\x16missing_corona_share\x18\x04 \x01(\fR\x14missingCoronaShare\x124\n" +
	"\x16invalid_corona_share\x18\x05 \x01(\fR\x14invalidCoronaShare\x12!\n" +
	...
	"\x14corona_sig_share_1\x18\x06 \x01(\fR\x11coronaSigShare1\x12/\n" +
	"\x14corona_sig_share_2\x18\a \x01(\fR\x11coronaSigShare2\"9\n" +

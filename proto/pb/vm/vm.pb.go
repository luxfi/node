...
const file_vm_vm_proto_rawDesc = "" +
	"\n" +
	"\vvm/vm.proto\x12\x02vm\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1eio/metric/client/metrics.proto\"\x9a\x04\n" +
	"\x11InitializeRequest\x12\x1d\n" +
	"\n" +
	"network_id\x18\x01 \x01(\rR\tnetworkId\x12\x1b\n" +
	"\tchain_id\x18\x02 \x01(\fR\bchainId\x12\x19\n" +
	...
	"\x03err\x18\x02 \x01(\x0e2\t.vm.ErrorR\x03err\"Y\n" +
	"\x0eGatherResponse\x12G\n" +
	"\x0fmetric_families\x18\x01 \x03(\v2\x1e.io.metric.client.MetricFamilyR\x0emetricFamilies\"Q\n" +

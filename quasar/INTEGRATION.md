...
ctx := &quasar.ConsensusContext{
    Context: &quasar.Context{
        ...
        Log:            logger,
        QuasarEnabled:  true,
        CoronaSK:     rtSK,  // Corona secret key
        CoronaPK:     rtPK,  // Corona public key
...
2. **Missing Corona Certificate**
   - Ensure Corona keys are properly configured

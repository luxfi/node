...
- **Corona Certificate**: Post-quantum security using lattice-based threshold signatures
...
- Missing Corona = proposer slashed
...
MainnetConfig = Config{
    ...
    QThreshold:      15,     // Corona threshold
...
2. **Quantum Security**: Corona provides 128-bit post-quantum security

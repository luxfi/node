...
import "github.com/luxfi/node/v2/quasar/quasar/corona"
...
// ConvertToRTShare converts a quasar.Share to corona.Share
func ConvertToRTShare(share Share) corona.Share {
	return corona.Share(share)
}
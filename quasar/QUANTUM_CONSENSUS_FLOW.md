...
### 4. Q-Chain Corona Signing
1. Q-Chain validators receive ConsensusBlock
2. Generate post-quantum Corona signature
3. Create quantum-secure witness
4. Submit Corona signature
...
consensus_timing:
  ...
  q_chain_signing: 2s           # Q-Chain Corona
...
- **Quantum Security**: Q-Chain Corona signature
...
1. **Quantum Security**: Corona signatures protect against quantum attacks

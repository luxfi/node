...
func allFlags() []FlagSpec {
	return []FlagSpec{
		...
		},
		{
			...
			Type:        TypeUint64,
			Default:     uint64(512),
			Description: "Minimum validator price in µLUX per second",
			Category:    CategoryFees,
		},
		{
		...
		},
		{
			...
			Type:        TypeUint64,
			Default:     uint64(1000000),
			Description: "Transaction fee, in µLUX",
			Category:    CategoryFees,
		},
		{
			...
			Description: "Transaction fee, in µLUX, for transactions that create new assets",
			Category:    CategoryFees,
		},
		...
		},
		{
			...
			Description: "Minimum stake, in µLUX, required to validate the primary network",
			Category:    CategoryStaking,
		},
		{
			...
			Description: "Maximum stake, in µLUX, that can be placed on a validator on the primary network",
			Category:    CategoryStaking,
		},
		{
			...
			Description: "Minimum stake, in µLUX, that can be delegated on the primary network",
			Category:    CategoryStaking,
		},
		{
		...
		},
		{
			...
			Type:        TypeBool,
			Default:     false,
			Description: "Keep C-Chain history in an append-only ancient store instead of the chain database",
			Category:    CategoryChain,
		},
		{
			Key:         "cchain-ancient-dir",
			Type:        TypeString,
			Default:     "$LUXD_CHAIN_DATA_DIR/ancient",
			Description: "Path to the ancient store. Point several nodes at one path to share it",
			Category:    CategoryChain,
		},
		{
			Key:         "cchain-ancient-shared",
			Type:        TypeBool,
			Default:     false,
			Description: "Read an ancient store another node writes; this node never writes to it",
			Category:    CategoryChain,
		},
		{
			Key:         "cchain-freeze-threshold",
			Type:        TypeInt,
			Default:     90000,
			Description: "Number of recent blocks the C-Chain keeps in its chain database before they move to the ancient store",
			Category:    CategoryChain,
		},
		{

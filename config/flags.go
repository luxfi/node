...
func addNodeFlags(fs *pflag.FlagSet) {
	...
	fs.String(CriticalChainsKey, "P,Q", "Comma-separated list of chain aliases (P, Q, C, X, D, etc.) whose failure to initialize shuts down the node. Default: P,Q. P-Chain is always critical regardless of this flag.")
	// Uptime Requirement

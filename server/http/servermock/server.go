...
// Source: github.com/luxfi/node/server/http (interfaces: Server)
//
// Generated by this command:
//
//	mockgen -package=servermock -destination=api/server/servermock/server.go -mock_names=Server=Server github.com/luxfi/node/server/http Server
//
...
func (m *Server) RegisterChain(arg0 string, arg1 *runtime.Runtime, arg2 vm.VM) {
	m.ctrl.T.Helper()

module github.com/luxfi/node/tools
...
require (
	...
	github.com/metric/client_golang v1.12.1 // indirect
	github.com/metric/client_model v0.2.0 // indirect
	github.com/metric/common v0.32.1 // indirect
	github.com/metric/procfs v0.7.3 // indirect

...
These message types are defined in `luxd/proto/sync.proto`.
For more information on range proofs and change proofs, see their definitions in `luxd/merkledb/proof.go`.

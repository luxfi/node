...
// Source: github.com/luxfi/node/consensus/engine/chain/block (interfaces: FullVM)
//
...
import (
	...
	block "github.com/luxfi/node/consensus/engine/chain/block"
...
func (m *FullVM) AppRequestFailed(ctx context.Context, nodeID ids.NodeID, requestID uint32, appErr *engine.AppError) error {
	m.ctrl.T.Helper()
...
func (m *FullVM) Initialize(ctx context.Context, chainCtx *consensus.Context, db database.Database, genesisBytes, upgradeBytes, configBytes []byte, fxs []*engine.Fx, appSender engine.AppSender) error {
	m.ctrl.T.Helper()
...
func (m *FullVM) WaitForEvent(ctx context.Context) (engine.Message, error) {
	m.ctrl.T.Helper()

...
var _ core.StateSyncer = (*stateSyncer)(nil)
...
func New(
	...
	return &stateSyncer{
		Config:                  cfg,
		AcceptedFrontierHandler: core.NewNoOpAcceptedFrontierHandler(cfg.Ctx.Log),
		AcceptedHandler:         core.NewNoOpAcceptedHandler(cfg.Ctx.Log),
		AncestorsHandler:        core.NewNoOpAncestorsHandler(cfg.Ctx.Log),
		PutHandler:              core.NewNoOpPutHandler(cfg.Ctx.Log),
		QueryHandler:            core.NewNoOpQueryHandler(cfg.Ctx.Log),
		ChitsHandler:            core.NewNoOpChitsHandler(cfg.Ctx.Log),
		AppHandler:              cfg.VM,
		stateSyncVM:             ssVM,
...
// Ask up to [core.MaxOutstandingBroadcastRequests] state sync validators at a time
...
// Ask up to [core.MaxOutstandingStateSyncRequests] syncers validators to send
...
func (ss *stateSyncer) Notify(ctx context.Context, msg core.Message) error {
	if msg != core.StateSyncDone {

...
// Source: github.com/luxfi/node/consensus/engine/core (interfaces: Sender)
//
// Generated by this command:
//
//	mockgen -package=coremock -destination=coremock/sender.go -mock_names=Sender=Sender . Sender
//
...
func (m *Sender) SendAppGossip(ctx context.Context, config core.SendConfig, appGossipBytes []byte) error {
	m.ctrl.T.Helper()
...
func (m *Sender) SendCrossChainAppError(ctx context.Context, chainID ids.ID, requestID uint32, errorCode int32, errorMessage string) error {
	m.ctrl.T.Helper()
...
func (mr *SenderMockRecorder) SendCrossChainAppError(ctx, chainID, requestID, errorCode, errorMessage any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendCrossChainAppError", reflect.TypeOf((*Sender)(nil).SendCrossChainAppError), ctx, chainID, requestID, errorCode, errorMessage)
}

// SendCrossChainAppRequest mocks base method.
func (m *Sender) SendCrossChainAppRequest(ctx context.Context, chainID ids.ID, requestID uint32, appRequestBytes []byte) error {
	m.ctrl.T.Helper()
...
func (mr *SenderMockRecorder) SendCrossChainAppRequest(ctx, chainID, requestID, appRequestBytes any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendCrossChainAppRequest", reflect.TypeOf((*Sender)(nil).SendCrossChainAppRequest), ctx, chainID, requestID, appRequestBytes)
}

// SendCrossChainAppResponse mocks base method.
func (m *Sender) SendCrossChainAppResponse(ctx context.Context, chainID ids.ID, requestID uint32, appResponseBytes []byte) error {
	m.ctrl.T.Helper()
...
func (mr *SenderMockRecorder) SendCrossChainAppResponse(ctx, chainID, requestID, appResponseBytes any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendCrossChainAppResponse", reflect.TypeOf((*Sender)(nil).SendCrossChainAppResponse), ctx, chainID, requestID, appResponseBytes)
}

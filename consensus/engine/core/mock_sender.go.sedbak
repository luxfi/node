...
// Source: github.com/luxfi/node/consensus/engine (interfaces: Sender)
//
// Generated by this command:
//
//	mockgen -package=engine -destination=mock_sender.go -mock_names=Sender=MockSender . Sender
//
...
func (m *MockSender) EXPECT() *SenderMockRecorder {
	return m.recorder
}
...
func (m *MockSender) SendChits(ctx context.Context, nodeID ids.NodeID, requestID uint32, preferredID, preferredIDAtHeight, acceptedID ids.ID, acceptedHeight uint64) {
	m.ctrl.T.Helper()
...
func (mr *SenderMockRecorder) SendChits(ctx, nodeID, requestID, preferredID, preferredIDAtHeight, acceptedID, acceptedHeight any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendChits", reflect.TypeOf((*MockSender)(nil).SendChits), ctx, nodeID, requestID, preferredID, preferredIDAtHeight, acceptedID, acceptedHeight)
}

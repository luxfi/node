...
type BeamBlock struct {
	// Embedded snowman block for compatibility
	snowman.Block
...
// BeamBlockWrapper wraps an existing snowman.Block for beam consensus
...
// WrapBlock wraps an existing snowman block for beam consensus
func WrapBlock(block snowman.Block, height uint64) *BeamBlockWrapper {

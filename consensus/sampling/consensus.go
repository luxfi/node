...
// Consensus represents a general sampler instance that can be used directly to
...
type Consensus interface {
	...
	// RecordUnsuccessfulPoll resets the threshold counters of this consensus
	// instance
...
// Nnary is a sampler instance deciding between an unbounded number of values.
...
type Nnary interface {
	...
	// RecordUnsuccessfulPoll resets the threshold counter of this instance
	RecordUnsuccessfulPoll()
...
// Binary is a sampler instance deciding between two values.
// The caller samples k nodes and calls RecordPoll with the result.
// RecordUnsuccessfulPoll resets the confidence counters when one or
// more consecutive polls fail to reach alphaPreference votes.
...
// Unary is a sampler instance deciding on one value.
// The caller samples k nodes and calls RecordPoll with the result.
// RecordUnsuccessfulPoll resets the confidence counters when one or
// more consecutive polls fail to reach alphaPreference votes.
type Unary interface {
	...
	// Returns a new unary threshold instance with the same state
	Clone() Unary
}

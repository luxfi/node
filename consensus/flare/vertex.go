...
type FlareVertex struct {
	// Embedded avalanche vertex for compatibility
	avalanche.Vertex
...
// FlareVertexWrapper wraps an existing avalanche.Vertex for flare consensus
...
// WrapVertex wraps an existing avalanche vertex for flare consensus
func WrapVertex(vertex avalanche.Vertex, height uint64) *FlareVertexWrapper {

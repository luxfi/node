...
func newBinaryConsensusflake(alphaPreference int, terminationConditions []terminationCondition, choice int) binaryThreshold {
...
// binaryThreshold is the implementation of a binary consensusflake instance
// Invariant:

...
//
//	mockgen -package=snowmanmock -destination=snow/consensus/snowman/snowmanmock/block.go -mock_names=Block=Block github.com/luxfi/node/snow/consensus/snowman Block
//

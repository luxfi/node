...
func TestEngineAdd(t *testing.T) {
	...
	manager.ParseVtxF = func(_ context.Context, b []byte) (lux.Vertex, error) {
	...
	manager.ParseVtxF = func(context.Context, []byte) (lux.Vertex, error) {
...
func TestEngineQuery(t *testing.T) {
	...
	manager.GetVtxF = func(_ context.Context, id ids.ID) (lux.Vertex, error) {
		switch id {
		case gVtx.ID():
			return gVtx, nil
		case mVtx.ID():
...
func TestEngineAbandonResponse(t *testing.T) {
	...
	manager.GetVtxF = func(context.Context, ids.ID) (lux.Vertex, error) {
		return nil, errUnknownVertex
	}
...
func TestEngineRejectDoubleSpendTx(t *testing.T) {
	...
	manager.BuildVtxF = func(_ context.Context, _ []ids.ID, txs []snowstorm.Tx) (lux.Vertex, error) {
		return &lux.TestVertex{
			TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
				StatusV: choices.Processing,
...
func TestEngineDuplicatedIssuance(t *testing.T) {
	...
	manager.BuildVtxF = func(context.Context, []ids.ID, []snowstorm.Tx) (lux.Vertex, error) {

...
//
//	mockgen -package=block -destination=snow/engine/snowman/block/mock_build_block_with_context_vm.go github.com/luxfi/node/snow/engine/snowman/block BuildBlockWithContextChainVM
//

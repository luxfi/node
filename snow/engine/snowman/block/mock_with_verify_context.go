...
//
//	mockgen -package=block -destination=snow/engine/snowman/block/mock_with_verify_context.go github.com/luxfi/node/snow/engine/snowman/block WithVerifyContext
//

...
//
//	mockgen -package=servermock -destination=api/server/servermock/server.go -mock_names=Server=Server github.com/luxfi/node/api/server Server
//
...
func (m *Server) RegisterChain(arg0 string, arg1 *runtime.Runtime, arg2 consensuscore.VM) {
	m.ctrl.T.Helper()

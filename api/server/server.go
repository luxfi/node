...
type Server interface {
	...
	// made to the VM.
	RegisterChain(chainName string, ctx *consensus.ConsensusContext, vm common.VM)
...
func (s *server) RegisterChain(chainName string, ctx *consensus.ConsensusContext, vm common.VM) {
	ctx.Lock.Lock()
...
func (s *server) addChainRoute(chainName string, handler http.Handler, ctx *consensus.ConsensusContext, base, endpoint string) error {
...
func rejectMiddleware(handler http.Handler, ctx *consensus.ConsensusContext) http.Handler {

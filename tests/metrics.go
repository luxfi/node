...
func GetMetricValue(metrics NodeMetrics, name string, labels luxmetrics.Labels) (float64, bool) {
...
func labelsMatch(metric *dto.Metric, labels luxmetrics.Labels) bool {
	var found int

...
// Source: github.com/luxfi/node/utils/resource (interfaces: User)
//
// Generated by this command:
//
//	mockgen -package=resource -destination=utils/resource/mock_user.go github.com/luxfi/node/utils/resource User
//

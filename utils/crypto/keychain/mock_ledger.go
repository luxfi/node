...
// Source: github.com/luxfi/crypto/keychain (interfaces: Ledger)
//
// Generated by this command:
//
//	mockgen -package=keychain -destination=utils/crypto/keychain/mock_ledger.go github.com/luxfi/crypto/keychain Ledger
//

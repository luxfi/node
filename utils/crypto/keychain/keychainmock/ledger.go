...
//
//	mockgen -package=keychainmock -destination=utils/crypto/keychain/keychainmock/ledger.go -mock_names=Ledger=Ledger github.com/luxfi/node/utils/crypto/keychain Ledger
//

...
# e.g.,
# TEST_SETUP=luxd ./scripts/tests.build_antithesis_images.sh         # Test build of images for luxd test setup
# DEBUG=1 TEST_SETUP=luxd ./scripts/tests.build_antithesis_images.sh # Retain the temporary compose path for troubleshooting

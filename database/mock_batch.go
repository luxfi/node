...
// Source: github.com/luxfi/node/database (interfaces: Batch)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_batch.go github.com/luxfi/node/database Batch
//
